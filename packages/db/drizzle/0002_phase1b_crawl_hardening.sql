...
CREATE UNIQUE INDEX "crawl_snapshots_ingestion_key_uq" ON "crawl_snapshots" USING btree ("ingestion_key");--> statement-breakpoint
...
CREATE INDEX "crawl_dlq_job_idx" ON "crawl_dlq" USING btree ("job_id");
