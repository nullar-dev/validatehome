      ...
      benefits: [
        {
          ...
          currency: { value: "USD" as Currency, confidence: 1.0 },
      ...
      benefits: [
        {
          ...
          incomeCap: { value: null, confidence: 0 },
          perUnitAmount: { value: null, confidence: 0 },
          currency: { value: "GBP" as Currency, confidence: 1.0 },
      ...
      benefits: [
        {
          ...
          incomeCap: { value: null, confidence: 0 },
          perUnitAmount: { value: null, confidence: 0 },
          currency: { value: "AUD" as Currency, confidence: 1.0 },
      ...
      benefits: [
        {
          ...
          incomeCap: { value: null, confidence: 0 },
          perUnitAmount: { value: null, confidence: 0 },
          currency: { value: "CAD" as Currency, confidence: 1.0 },
